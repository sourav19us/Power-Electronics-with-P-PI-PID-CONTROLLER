...
MODEL                = mppt
MODULES              = rt_logging.c mppt.c mppt_capi.c mppt_data.c mppt_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = mppt.exe
MAKEFILE             = mppt.mk
MATLAB_ROOT          = F:/MAT
ALT_MATLAB_ROOT      = F:/MAT
MATLAB_BIN           = F:/MAT/bin
ALT_MATLAB_BIN       = F:/MAT/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = F:/LAB/code
...
rtiostream_utils.obj : F:\MAT\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) F:\MAT\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
